...
<body>
<img id="image" width="1000" height="95" src="https://cdn.discordapp.com/attachments/1060253839351103520/1164791017648705607/MOF.png"></img>
    <form method="post">
...
if (isset($_POST['btnGrabar_x']) && isset($_POST['btnGrabar_y'])) {
    ...
    if (mysqli_num_rows($resultado) > 0) {
        ...
        $sql = "UPDATE anotaciones SET DESCRIPCION='$dilan', FECHA='$hizo', HORA='$nada', TIPO_ANOTACION='$en', FUNCIONARIO='$este', ASIGNATURA='$trabajo' WHERE ALUMNO='$no' AND N°ANOTACIONES='$el'";
